 ...
 *
 */
public class RecommendationHintDecorator 
extends AbstractDecorator implements RecommendationHint {

	static final private String HINT_ID = 
		"tw.edu.nccu.shuttle.GMFIntegrationDemo2.RecommendationHint";
...
//		removeDecoration();								// failed!
	 ...
	 * 
	 * @see tw.edu.nccu.shuttle.sandbox.RecommendationHint#show(tw.edu.nccu.shuttle.sandbox.Rule)
	 */
	 ...
	 * 
	 * @see tw.edu.nccu.shuttle.sandbox.RecommendationHint#hide(tw.edu.nccu.shuttle.sandbox.Rule)
	 */
