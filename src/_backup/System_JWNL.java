...
public class System extends AbstractUIPlugin {
	...
	// TODO: The plug-in ID, which is NOT automatically synchronized to plugin.xml
	public static final String PLUGIN_ID = "tw.edu.nccu.shuttle";
...
//	final static public Rule demoRule = new Rule();
	...
	public void start(BundleContext context) throws Exception {
		...
		JWNL.initialize(FileLocator.openStream(
				context.getBundle(), new Path("file_properties.xml"), false));
