 ...
 * switching) in the 
 * {@link org.eclipse.TextHoverSourceViewerConfiguration.ui.text.JavaSourceViewerConfiguration#getStringScanner 
 * StringScanner} of
 * {@link org.eclipse.TextHoverSourceViewerConfiguration.ui.text.JavaSourceViewerConfiguration 
...
//		new BreakIteratorRules_en_US_TEST();
	 ...
	 * {@link BreakIterator#getSentenceInstance()}.
	 */
	 ...
	 * 	no impact!
	 * @see tw.edu.nccu.shuttle.Boundaries#getImpactAreaInHost(java.lang.Object)
	 */
...
//			}
			...
			public Editing<Character> next() {
				...
				try {
					...
					throw new NoSuchElementException("No more alignments!");
				}
			}
